...
+                  <h3 className="text-xl lg:text-2xl font-bold text-blue-600">
                 ...
                 <div className="space-y-4">
-                  <h3 className="text-2xl font-bold text-gray-900">Articulação do Joelho</h3>
...
-                <div className="text-sm text-gray-700">Ligamentos Principais</div>
...
-                <div className="text-sm text-gray-700">Meniscos</div>
...
-                <div className="text-sm text-gray-700">Ossos Principais</div>
...
-                <div className="text-sm text-gray-700">Amplitude de Flexão</div>
