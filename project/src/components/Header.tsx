    ...
    <header className={`fixed w-full z-50 transition-all duration-500 ${
      ...
      <div className="container mx-auto px-4 py-3">
        <div className="flex items-center justify-between">
          ...
          {/* Mobile Menu Button */}
          <button
            className="md:hidden p-2 rounded-lg bg-blue-50/50 backdrop-blur-sm"
        ...
        {/* Mobile Menu */}
        {isMenuOpen && (
          <div className="md:hidden mt-4 pb-4 border-t border-blue-100/30 bg-white/90 backdrop-blur-lg rounded-lg">
